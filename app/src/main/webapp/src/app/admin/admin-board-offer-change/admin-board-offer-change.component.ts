...
@Component({
  selector: 'app-admin-board-offer-change',
  templateUrl: './admin-board-offer-change.component.html',
  styleUrls: ['./admin-board-offer-change.component.scss']
})
export class AdminBoardOfferChangeComponent implements OnInit {
