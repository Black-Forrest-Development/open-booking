...
import {VisitorGroup, VisitorGroupChangeRequest} from "../../../visitor-group/model/visitor-group-api";


@Injectable({
  providedIn: 'root'
})
export class VisitorGroupAdminService extends BaseService {

  constructor(http: HttpClient, logging: LoggingService) {
    super(http, 'backend/group', logging)
  }

  getAllVisitorGroup(page: number, size: number): Observable<Page<VisitorGroup>> {
